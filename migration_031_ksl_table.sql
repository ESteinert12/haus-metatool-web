-- migration_031_ksl_table.sql
-- Seed KSL lookup table from HAUS masterlist

CREATE TABLE IF NOT EXISTS ksl (ksl_id SERIAL PRIMARY KEY, ksl_name TEXT NOT NULL UNIQUE);

INSERT INTO ksl (ksl_name) VALUES
('A Great Big World'),
('Above & Beyond'),
('AC/DC'),
('Adele'),
